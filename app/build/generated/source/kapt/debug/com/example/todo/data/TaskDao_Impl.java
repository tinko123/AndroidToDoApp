  ...
  public TaskDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTask = new EntityInsertionAdapter<Task>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `tasks` (`id`,`title`,`description`,`done`) VALUES (nullif(?, 0),?,?,?)";
      }
    ...
    this.__updateAdapterOfTask = new EntityDeletionOrUpdateAdapter<Task>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `tasks` SET `id` = ?,`title` = ?,`description` = ?,`done` = ? WHERE `id` = ?";
      }
      ...
      public List<Task> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _tmpDone = _tmp != 0;
            _item = new Task(_tmpId,_tmpTitle,_tmpDescription,_tmpDone);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public Task call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _tmp = _cursor.getInt(_cursorIndexOfDone);
            _tmpDone = _tmp != 0;
            _result = new Task(_tmpId,_tmpTitle,_tmpDescription,_tmpDone);
          } else {
            _result = null;
          }
          return _result;
